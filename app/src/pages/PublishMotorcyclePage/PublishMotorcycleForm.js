...
import publishMotorcycleSchema, { InitialValues } from './publishMotorcycleSchema'
import { usePublishContext } from 'context/PublishMotorcycleConytext'

function PublishMotorcycleForm() {
  const { handleSubmit } = usePublishContext()

  return (
    <Formik
      initialValues={InitialValues}
      validationSchema={publishMotorcycleSchema}
      autoComplete='off'
...
export default PublishMotorcycleForm
