...
export const ElectricCarBrandList = [{
  name: 'Toyota',
  slug: 'toyota',
  image: {
    source: 'https://www.carlogos.org/car-logos/toyota-logo-2019-3700x1200-show.png',
  ...
  image: {
    ...
    optimized: 'https://logos-world.net/wp-content/uploads/2021/03/Jaguar-Logo.png',
  ...
  image: {
    ...
    optimized: 'https://www.carlogos.org/car-logos/maxus-logo.png',
  ...
  image: {
    ...
    optimized: 'https://www.carlogos.org/car-logos/lexus-logo.png',
  ...
  slug: 'bmw',
  image: {
    source: 'https://www.carlogos.org/car-logos/bmw-logo-2020-blue-white-show.png',
...
},
{
  ...
  slug: 'tesla',
  image: {
    source: 'https://www.carlogos.org/car-logos/tesla-logo-2200x2800-show.png',
    thumb: 'https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/thumb/tesla.png',
    optimized: 'https://www.pngplay.com/wp-content/uploads/13/Tesla-Logo-Download-Free-PNG.png',
...
},
{
  ...
  image: {
    ...
    optimized: 'https://logos-world.net/wp-content/uploads/2021/03/Chevrolet-Logo.png',
  ...
  image: {
    ...
    optimized: 'https://www.freepnglogos.com/uploads/hyundai-logo-15.gif',
...
},
{
  ...
  image: {
    ...
    optimized: 'https://www.pngplay.com/wp-content/uploads/13/Renault-Logo-PNG-Photos.png',
  ...
  image: {
    ...
    optimized: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/BYD_Auto_Logo.svg/1280px-BYD_Auto_Logo.svg.png',
...
},
{
  ...
  slug: 'porsche',
  image: {
    source: 'https://www.carlogos.org/car-logos/porsche-logo-2100x1100-show.png',
  ...
  image: {
    ...
    optimized: 'https://upload.wikimedia.org/wikipedia/commons/1/13/Kia-logo.png',
  ...
  image: {
    ...
    optimized: 'https://www.carlogos.org/logo/JAC-Motors-logo-2016-1920x1080.png',
  ...
  image: {
    ...
    optimized: 'https://logos-download.com/wp-content/uploads/2016/04/Geely_logo.png',
  ...
  image: {
    ...
    optimized: 'https://www.pngmart.com/files/10/Mini-Cooper-Logo-PNG-Transparent-Image.png',
  ...
  image: {
    ...
    optimized: 'https://upload.wikimedia.org/wikipedia/commons/3/3c/Volvo_Trucks_Logo.png',
  ...
  image: {
    ...
    optimized: 'https://upload.wikimedia.org/wikipedia/commons/8/8c/JMC_Motor_logo.png',
  ...
  image: {
    ...
    optimized: 'https://www.carlogos.org/logo/MG-logo-red-2010-1920x1080.png',
  ...
  image: {
    ...
    optimized: 'https://assets.stickpng.com/images/580b585b2edbce24c47b2cf2.png',
...
export const MotorCycleBrandList = [
  {
    id: 1,
    name: 'Tinbot',
    slug: 'tinbot',
    image: {
      optimized: 'https://www.motoplanete.com/Tinbot/Tinbot-Logo-180px.webp'
    }
  },
  {
    id: 2,
  ...
  },
  {
    ...
    slug: 'ktm',
    image: {
      optimized: 'https://www.svgrepo.com/show/303486/ktm-10-logo.svg'
    }
  },
  {
    id: 4,
    ...
    slug: 'segway',
    image: {
      optimized: 'https://logos-download.com/wp-content/uploads/2016/10/Segway_logo_logotype.png'
    }
  },
  {
    id: 5,
    ...
    slug: 'eve',
    image: {
      optimized: 'https://seeklogo.com/images/E/eve-logo-8314F66B21-seeklogo.com.png'
    }
  },
  {
    id: 6,
    ...
    slug: 'gasgas',
    image: {
      optimized: 'http://logo-logos.com/2016/12/GASGAS_logo_logotipo_Gas_Gas.png'
    }
  },
  {
    id: 7,
  ...
  },
  {
    ...
    slug: 'dendou',
    image: {
      optimized: 'https://www.dendoubikes.com/s/misc/logo.png?t=1661530516'
    }
  },
  {
    id: 10,
    ...
    slug: 'niu',
    image: {
      optimized: 'https://s.niucache.com/www/niu-i18n/icons/icon_512x512.1e4979.png'
    }
  },
  {
    id: 11,
    ...
    slug: 'vespa',
    image: {
      optimized: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Vespa-logo.svg/2560px-Vespa-logo.svg.png'
    }
  },
  {
    id: 120,
    ...
    slug: 'yamaha',
    image: {
      optimized: 'https://motosymbol.com/wp-content/uploads/2021/02/Yamaha-Logo.png'
    }
  }
]
